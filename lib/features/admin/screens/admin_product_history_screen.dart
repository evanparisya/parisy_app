...
class AdminProductHistoryScreen extends StatefulWidget {
  const AdminProductHistoryScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('History Barang Terdaftar', style: TextStyle(color: AppColors.primaryBlack, fontWeight: FontWeight.bold)),
      ),
