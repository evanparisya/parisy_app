    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.delivery_dining, color: AppColors.primaryBlack, size: 18),
              SizedBox(width: 4),
              Text('Delivery to 112 Diniyah, Riyadh', style: TextStyle(fontSize: 12, color: AppColors.neutralDarkGray)),
              Spacer(),
              Icon(Icons.notifications_none, color: AppColors.primaryBlack, size: 24),
              SizedBox(width: 8),
              Icon(Icons.shopping_cart_outlined, color: AppColors.primaryBlack, size: 24),
            ],
          ),
          SizedBox(height: 4),
          Text(
            'Hungry? Order & Eat.',
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: AppColors.primaryBlack),
          ),
        ],
      ),
    );
...
class _CategoryItem extends StatelessWidget {
  ...
  const _CategoryItem({required this.label, required this.icon, required this.isSelected, required this.onTap});

  @override
  Widget build(BuildContext context) {
    final color = isSelected ? AppColors.primaryBlack : AppColors.neutralDarkGray;
