...
// User Features (Marketplace, Cart, Orders, Profile)
  ...
  static List<SingleChildWidget> provideProviders() {
    return [
      ...
      ProxyProvider<ApiClient, UserManagementService>(
        update: (_, apiClient, __) => UserManagementService(apiClient: apiClient),
      ),
      ChangeNotifierProxyProvider<UserManagementService, UserManagementController>(
        create: (context) => UserManagementController(service: context.read<UserManagementService>()),
        update: (_, service, existingController) => UserManagementController(service: service),
      ),
      ...
      ChangeNotifierProxyProvider<FinanceService, FinanceController>(
        create: (context) => FinanceController(service: context.read<FinanceService>()),
        update: (_, service, existingController) => FinanceController(service: service),
      ),
      ...
      ChangeNotifierProxyProvider<ReportingService, ReportingController>(
        create: (context) => ReportingController(service: context.read<ReportingService>()),
        update: (_, service, existingController) => ReportingController(service: service),
      ),
      ...
      ChangeNotifierProxyProvider<MarketplaceService, MarketplaceController>(
        create: (context) => MarketplaceController(marketplaceService: context.read<MarketplaceService>()),
        update: (_, service, existingController) => MarketplaceController(marketplaceService: service),
      ),
      ...
      ChangeNotifierProxyProvider2<OrderService, AuthController, OrderController>(
        create: (context) => OrderController(
          orderService: context.read<OrderService>(),
          authController: context.read<AuthController>(),
        ),
        update: (_, service, authController, existingController) => OrderController(
      ...
      ChangeNotifierProxyProvider2<CartService, AuthController, CartController>(
        ...
        update: (_, service, authController, existingController) => CartController(
          cartService: service,
          authController: authController,
        ),
      ),
      ...
      ChangeNotifierProxyProvider<AuthController, ProfileController>(
        create: (context) => ProfileController(authController: context.read<AuthController>()),
        update: (_, authController, existingController) => ProfileController(authController: authController),
      ),
    ];
  }
}